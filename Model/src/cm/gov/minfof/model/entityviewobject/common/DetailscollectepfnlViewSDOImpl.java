...
public class DetailscollectepfnlViewSDOImpl extends SDODataObject implements DetailscollectepfnlViewSDO {
   ...
   public cm.gov.minfof.model.entityviewobject.common.PermissionnairespnflViewSDO getPermissionnairespnflView() {
      return (cm.gov.minfof.model.entityviewobject.common.PermissionnairespnflViewSDO)get(START_PROPERTY_INDEX + 17);
   }
   ...
   public cm.gov.minfof.model.entityviewobject.common.PermisViewSDO getPermisView() {
      return (cm.gov.minfof.model.entityviewobject.common.PermisViewSDO)get(START_PROPERTY_INDEX + 18);
   }
   ...
   public cm.gov.minfof.model.entityviewobject.common.UnitemesureViewSDO getUnitemesureView() {
      return (cm.gov.minfof.model.entityviewobject.common.UnitemesureViewSDO)get(START_PROPERTY_INDEX + 20);
   }
   ...
   public cm.gov.minfof.model.entityviewobject.common.DepartementViewSDO getDepartementView() {
      return (cm.gov.minfof.model.entityviewobject.common.DepartementViewSDO)get(START_PROPERTY_INDEX + 21);
   }
   ...
   public cm.gov.minfof.model.entity.common.PartiesProduitsPfnlViewSDO getPartiesProduitsPfnlView() {
      return (cm.gov.minfof.model.entity.common.PartiesProduitsPfnlViewSDO)get(START_PROPERTY_INDEX + 22);
   }
