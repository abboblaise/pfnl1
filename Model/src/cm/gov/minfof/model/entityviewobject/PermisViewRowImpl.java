...
public class PermisViewRowImpl extends ViewRowImpl {
    ...
    public static final int IDCEQEFILTRE = AttributesEnum.IdceqeFiltre.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute numeroceqe.
     * @return the numeroceqe
     */
    public String getnumeroceqe() {
        String result = "";
        AppModuleImpl am = (AppModuleImpl)this.getApplicationModule();
        ViewObjectImpl voIm = am.getCeqeView1();
        voIm.setWhereClause("Idceqe="+getIdceqe());
        voIm.executeQuery();
        if (voIm.hasNext()){
            Row r = voIm.next();
            result = r.getAttribute("Numeroceqe").toString();
            }
        return result;
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute numeroceqe.
    ...
    /**
     * Gets the attribute value for idceqe using the alias name IdceqeFiltre.
     * @return the idceqe
     */
    public BigDecimal getIdceqeFiltre() {
        return (BigDecimal) getAttributeInternal(IDCEQEFILTRE);
    }

    /**
     * Sets <code>value</code> as attribute value for idceqe using the alias name IdceqeFiltre.
     * @param value value to set the idceqe
     */
    public void setIdceqeFiltre(BigDecimal value) {
        setAttributeInternal(IDCEQEFILTRE, value);
    }
