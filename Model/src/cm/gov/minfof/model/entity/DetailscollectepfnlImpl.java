...
public class DetailscollectepfnlImpl extends EntityImpl {
    ...
    public static final int IDCAT = AttributesEnum.idcat.index();
    ...
    /**
     * Gets the attribute value for idcat, using the alias name idcat.
     * @return the value of idcat
     */
    public BigDecimal getidcat() {
        return (BigDecimal) getAttributeInternal(IDCAT);
    }

    /**
     * Sets <code>value</code> as the attribute value for idcat.
     * @param value value to set the idcat
     */
    public void setidcat(BigDecimal value) {
        setAttributeInternal(IDCAT, value);
    }
